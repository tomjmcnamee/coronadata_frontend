...
const returnGroupedStateStatesDropdownObjects = (label) => {
  switch (label) {
    ...
    case "2020 Biden States": return [{value: 3, label: "Arizona", stateabbreviation: "AZ"},{value: 5, label: "California", stateabbreviation: "CA"},{value: 6, label: "Colorado", stateabbreviation: "CO"},{value: 7, label: "Connecticut", stateabbreviation: "CT"},{value: 8, label: "Delaware", stateabbreviation: "DE"},{value: 48, label: "Washington DC", stateabbreviation: "DC"},{value: 10, label: "Georgia", stateabbreviation: "GA"},{value: 11, label: "Hawaii", stateabbreviation: "HI"},{value: 13, label: "Illinois", stateabbreviation: "IL"},{value: 19, label: "Maine", stateabbreviation: "ME"},{value: 20, label: "Maryland", stateabbreviation: "MD"},{value: 21, label: "Massachusetts", stateabbreviation: "MA"},{value: 22, label: "Michigan", stateabbreviation: "MI"},{value: 23, label: "Minnesota", stateabbreviation: "MN"}, {value: 28, label: "Nevada", stateabbreviation: "NV"},{value: 29, label: "New Hampshire", stateabbreviation: "NH"},{value: 30, label: "New Jersey", stateabbreviation: "NJ"},{value: 31, label: "New Mexico", stateabbreviation: "NM"},{value: 32, label: "New York", stateabbreviation: "NY"},{value: 37, label: "Oregon", stateabbreviation: "OR"},{value: 38, label: "Pennsylvania", stateabbreviation: "PA"},{value: 39, label: "Rhode Island", stateabbreviation: "RI"},{value: 45, label: "Vermont", stateabbreviation: "VT"},{value: 46, label: "Virginia", stateabbreviation: "VA"},{value: 47, label: "Washington", stateabbreviation: "WA"},{value: 50, label: "Wisconsin", stateabbreviation: "WI"}  ]
    case "2020 Trump States": return [{value: 1, label: "Alabama", stateabbreviation: "AL"},{value: 2, label: "Alaska", stateabbreviation: "AK"},{value: 4, label: "Arkansas", stateabbreviation: "AR"},{value: 9, label: "Florida", stateabbreviation: "FL"},{value: 12, label: "Idaho", stateabbreviation: "ID"},{value: 14, label: "Indiana", stateabbreviation: "IN"},{value: 15, label: "Iowa", stateabbreviation: "IA"},{value: 16, label: "Kansas", stateabbreviation: "KS"},{value: 17, label: "Kentucky", stateabbreviation: "KY"},{value: 18, label: "Louisiana", stateabbreviation: "LA"},{value: 24, label: "Mississippi", stateabbreviation: "MS"},{value: 25, label: "Missouri", stateabbreviation: "MO"},{value: 26, label: "Montana", stateabbreviation: "MT"},{value: 27, label: "Nebraska", stateabbreviation: "NE"},{value: 33, label: "North Carolina", stateabbreviation: "NC"},{value: 34, label: "North Dakota", stateabbreviation: "ND"},{value: 35, label: "Ohio", stateabbreviation: "OH"},{value: 36, label: "Oklahoma", stateabbreviation: "OK"},{value: 40, label: "South Carolina", stateabbreviation: "SC"},{value: 41, label: "South Dakota", stateabbreviation: "SD"},{value: 42, label: "Tennessee", stateabbreviation: "TN"},{value: 43, label: "Texas", stateabbreviation: "TX"},{value: 44, label: "Utah", stateabbreviation: "UT"},{value: 49, label: "West Virginia", stateabbreviation: "WV"},{value: 51, label: "Wyoming", stateabbreviation: "WY"}]
...
const returnGroupObjLabelFromCastedValuesArrString = (CastedValuesArrString) => {
  switch (CastedValuesArrString) {
    ...
    case "3,5,6,7,8,10,11,13,19,20,21,22,23,28,29,30,31,32,37,38,39,45,46,47,48,50": return "2020 Biden States"
    case "1,2,4,9,12,14,15,16,17,18,24,25,26,27,33,34,35,36,40,41,42,43,44,49,51": return "2020 Trump States"
...
const stateGroupDropdownOptionsArr = [
  ...
  {value: 117, label: "2016 Trump States", stateabbreviation: "Trump2016"},
  {value: 118, label: "2020 Biden States", stateabbreviation: "Biden2020"},
  {value: 119, label: "2020 Trump States", stateabbreviation: "Trump2020"}
  ]
