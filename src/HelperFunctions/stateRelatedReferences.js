...
const returnGroupedStateStateDropdownOptionObjWithStateName = (stateName) => {
  switch (stateName) {
    case "Governer - D": return [{value: 5, label: "California", stateabbreviation: "CA"},{value: 6, label: "Colorado", stateabbreviation: "CO"},{value: 7, label: "Connecticut", stateabbreviation: "CT"},{value: 8, label: "Delaware", stateabbreviation: "DE"}]
    case "Governer - R": return [{value: 1, label: "Alabama", stateabbreviation: "AL"},{value: 2, label: "Alaska", stateabbreviation: "AK"},{value: 3, label: "Arizona", stateabbreviation: "AZ"},{value: 4, label: "Arkansas", stateabbreviation: "AR"}]
    // case "Alabama": return []
    // case "Alaska": return []
    // case "Arizona": return []
    // case "Arkansas": return []
    // case "California": return [
    // case "Colorado": return [{
    // case "Connecticut": return [
    // case "Delaware": return [
    // case "Florida": return [{value: 9, label: "Florida", stateabbreviation: "FL"}]
    // case "Georgia": return [{value: 10, label: "Georgia", stateabbreviation: "GA"}]
    // case "Hawaii": return [{value: 11, label: "Hawaii", stateabbreviation: "HI"}]
    // case "Idaho": return [{value: 12, label: "Idaho", stateabbreviation: "ID"}]
    ...
    default: return "returnGroupedStateStateDropdownOptionObjWithStateName switch  case in HelperFunctions/stateRelatedReferences.js"
  } // ends switch/case 
}
...
const returnAllDropdownOptionsForStateMultiselect = () => {
  return [
    ...
    // {value: 101, label: "Governer - D", stateabbreviation: "DEM"},
    // {value: 102, label: "Governer - R", stateabbreviation: "REP"},
...
export { 
  ...
  returnGroupedStateStateDropdownOptionObjWithStateName
 }