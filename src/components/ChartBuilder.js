      ...
      case "top10s":
        ...
        if (top10sDataSet.length > 0 ) {
          ...
          return( 
            ...
            {this.props.includeGridLines.includePositivePercent ? <div className="setScales"
              style={{
                // display: "inlineBlock",
                // float: "left",
                // clear: "both"
            ...
            >
              ...
              >
                <div><label>Set Perecentage Scale</label></div>
                <div><input type="range" min="0" max="100" value="7" step="1"/></div>
              </div>  
