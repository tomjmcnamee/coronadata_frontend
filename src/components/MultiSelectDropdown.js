...
const MultiSelectDropdown: React.FC = (props) => {
  ...
  // console.log("store", store.multiSelectedStatesIdsArr)

  console.log("selected in STATE", selected)


  
  function multidropdownChangeHandler(event) {
    
    
    // console.log("event[0].value  --- ", [event[0].value] )
    // if (event[0].value < 80) {
    //   // debugger
    //   props.setMultiSelectedStates([event[0].value], store.multiSelectedStatesIdsArr)
    // }   else {
    //   props.setMultiSelectedStates(mapMultiDropdownValueToRegionIDsArr(event[0].value), store.multiSelectedStatesIdsArr)
    // }
  ...
  // function selectedDropdownOptions() {
  //   // debugger
  //   let selected = dropdownOptions.filter(function(st){
  //     return store.multiSelectedStatesIdsArr.indexOf(st.value) != -1;
  //   });
  //   return selected
  // } 

  // function callbacks(setSelected) {
  //   debugger
  //   setSelected()
  //   props.setMultiSelectedStates(selected)
  // }
